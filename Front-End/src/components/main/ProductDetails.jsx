  ...
  return (
    ...
    >
      <Box sx={{ display: "flex" }}>
        <img
          width={400}
          src={`${process.env.REACT_APP_BASE_URL}${clickedProduct.attributes.productimg.data[selectedImg].attributes.url}`}
          alt=""
        />
      </Box>
              ...
              return (
                ...
                >
                  <img
                    ...
                    height={"100%"}
                    width={"100%"}
                    src={`${process.env.REACT_APP_BASE_URL}${item.attributes.url}`}
                    alt=""
                  />
                </ToggleButton>
              );
